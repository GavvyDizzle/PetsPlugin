...
public class GeneralRewardBoost extends Boost {

    private final String multiplierEquation;
    private final boolean isMultiplicative;

    public GeneralRewardBoost(String id, String multiplierEquation, boolean isMultiplicative) {
        super(BoostType.GENERAL_REWARD, id);
