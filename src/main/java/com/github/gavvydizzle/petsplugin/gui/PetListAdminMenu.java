 ...
 */
public class PetListAdminMenu implements ClickableMenu {
    ...
    public PetListAdminMenu(InventoryManager inventoryManager, PetManager petManager) {
    ...
    public void reloadContents() {
        ...
        petItems.clear();
        for (Pet pet : pets) {
            petItems.add(pet.getAdminPetListItemStack());
        }
    }
